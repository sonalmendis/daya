		...
		<img class="grey-marker one" src="img/timeline/grey-marker.svg" alt="Grey Marker" />
			...
			<div class="cd-timeline__block js-cd-block">
				...
				<div class="cd-timeline__content js-cd-content">
					...
					<div class="seperator"></div>
					<p>Daya quickly made quantum progress with his construction company, Daya Construction (Private) Limited. It was the first local contractor ever to lead World Bank funded road sector development project for the Ampara – Mahaoya Road</p>
				</div> <!-- cd-timeline__content -->
			</div> <!-- cd-timeline__block -->
			...
			<div class="cd-timeline__block js-cd-block">
				...
				<div class="cd-timeline__content js-cd-content">
					<h3>Daya apparel</h3>
					<div class="seperator"></div>
					<p>Daya soon submerged himself in the business arena and in 1992, he entered into the garment manufacturing industry. Daya Apparel Export (Private) Limited now has well-established 07 factories in Ampara and Sevanagala providing employment to over 4,000 people.</p>
				</div> <!-- cd-timeline__content -->
			</div> <!-- cd-timeline__block -->
			...
			<div class="cd-timeline__block js-cd-block">
				...
				<div class="cd-timeline__content js-cd-content">
					<h3>Growth</h3>
					<div class="seperator"></div>
					<p>In 2002, Daya Group purchased Sevanagala Sugar Industries Limited which was running at an operational loss of over Rs. 150 million annual. Within a short span of 2 years, the management team transformed the business, improving its capacity by 300%.</p>
				</div> <!-- cd-timeline__content -->
			</div> <!-- cd-timeline__block -->
			...
			<div class="cd-timeline__block js-cd-block">
				...
				<div class="cd-timeline__content js-cd-content">
					<h3>Daya Aviation</h3>
					<div class="seperator"></div>
					<p>The investment in a six seater aircraft catapulted the start of Daya Aviation (Private) Limited. In 2008, Daya Aviation managed to purchase a 19 seater aircraft, which currently operates in the USA.</p>
				</div> <!-- cd-timeline__content -->
			</div> <!-- cd-timeline__block -->
